...
# Form implementation generated from reading ui file 'OGmaoyanpiaofang.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pushButton_9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "猫眼票房"))
        self.label_2.setText(_translate("MainWindow", "搜索规则："))
        self.radioButton_1.setText(_translate("MainWindow", "实时票房（当前时间）"))
        self.radioButton_2.setText(_translate("MainWindow", "时间段票房（每日）"))
